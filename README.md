...
![AURA hero banner](assets/hero_banner.png)
...
2. Make sure `hero_banner.png` is placed inside an `assets/` folder next to `index.html` (or update the image path in `index.html` if you keep it elsewhere).
